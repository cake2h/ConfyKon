...
<header class="header-buttons">
  <nav>
    ...
    <div>
        <a href="{{ route('conf.index') }}" style="margin-left: 14px; margin-right: 14px;">Список конференций</a>
        @if (Auth::user()->isAdmin())
            <a href="{{ route('admin.index') }}" style="margin-left: 14px; margin-right: 14px;">Админ-панель</a>
        @endif

        <a href="#" style="margin-left: 14px; margin-right: 14px;" onclick="event.preventDefault(); document.getElementById('logoutForm').submit();">Выход</a>
